...
function renderTable(matches){
  ...
  matches.forEach(function(m){
    ...
    tr.innerHTML =
      ...
      '<td class="odds-cell"><span class="odds-val odds-w">'+fmtPct(m.model_win)+'</span> <span class="odds-val odds-d">'+fmtPct(m.model_draw)+'</span> <span class="odds-val odds-l">'+fmtPct(m.model_loss)+'</span><div class="lgbm-prob">中值 '+fmtPct(m.lgbm_prediction_prob)+' · '+dirText(m.lgbm_prediction)+'</div></td>'+      '<td class="lgbm-cell"><span class="odds-val odds-w">'+fmtPct(m.lgbm_win)+'</span> <span class="odds-val odds-d">'+fmtPct(m.lgbm_draw)+'</span> <span class="odds-val odds-l">'+fmtPct(m.lgbm_loss)+'</span><div class="lgbm-sub">LGBM '+fmtPct(m.prediction_prob)+' · '+dirText(m.prediction)+'</div></td>';
