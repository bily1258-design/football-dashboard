#!/usr/bin/env python3
"""Write the updated script.js with score and hit columns."""
import os

js_content = r'''// script.js — 足彩价值投注看板
var allData = null;
var allMatches = [];
...
base = '/data/data/com.termux/files/home/football-dashboard/docs'
...
# Update CSS
with open(os.path.join(base, 'style.css'), 'a', encoding='utf-8') as f:
